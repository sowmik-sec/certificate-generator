...
const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  const handlePropertyChange = (prop: string, value: any) => {
    ...
    if (selectedObject.type === "group") {
      ...
      if ("forEachObject" in selectedObject && typeof (selectedObject as any).forEachObject === "function") {
  ...
  const isShape = ["rect", "circle", "triangle", "ellipse", "path"].includes(selectedObject.type || "");
  ...
  const hasTextInGroup = isGroup && (selectedObject as any)._objects?.some((obj: any) => obj.type === "textbox");
  ...
  return (
    <div className="space-y-6 max-h-full overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-1">
              <button
                onClick={() => handlePropertyChange("fontWeight", attributes.fontWeight === "bold" ? "normal" : "bold")}
              ...
              <button
                onClick={() => handlePropertyChange("fontStyle", attributes.fontStyle === "italic" ? "normal" : "italic")}
                className={`p-2 rounded border ${
              ...
              <button
                onClick={() => handlePropertyChange("underline", !attributes.underline)}
                className={`p-2 rounded border ${
          ...
          <div>
            ...
            <div className="flex gap-1">
              {["left", "center", "right"].map((align) => {
                const IconComponent = align === "left" ? AlignLeft : align === "center" ? AlignCenter : AlignRight;
                return (
                  <button
                    key={align}
      ...
      {isShape && (
        <div className="space-y-4">
          <h4 className="font-semibold text-gray-700 border-b pb-1">Appearance</h4>
      ...
      {!isGroup && (
        <div className="space-y-4">
          <h4 className="font-semibold text-gray-700 border-b pb-1">Position & Size</h4>
